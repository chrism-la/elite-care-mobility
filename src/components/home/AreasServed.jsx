                ...
                <div className="overflow-hidden rounded-[2rem] border border-[#E5E7EB] bg-white shadow-sm">
                    <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
                        <div className="bg-[#12355B] p-8 text-white sm:p-10 lg:p-12">
                            ...
                            <h2 className="mt-6 text-3xl font-semibold tracking-tight sm:text-4xl">Serving local communities with dependable mobility support</h2>
                            ...
                            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                                <CTAButton href="/contact" variant="orange">
                                    Request a Ride
                                </CTAButton>

                                <a
                                    href={business.phoneHref}
                                    className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-white/20 px-6 py-3 font-semibold text-white transition hover:bg-white/10"
                                >
                                    <PhoneCall size={18} />
                                    Call Now
                                </a>
                        ...
                        <div className="bg-[#EFF6FF]/60 p-8 sm:p-10 lg:p-12">
                            <p className="text-sm font-semibold uppercase tracking-wide text-[#F97316]">Areas Served</p>

                            <div className="mt-6 grid gap-3 sm:grid-cols-2">
                                {areas.map((area) => (
                                    <div key={area} className="rounded-2xl border border-white bg-white px-5 py-4 text-base font-semibold text-[#12355B] shadow-sm">
                                        {area}
                                    </div>
                                ))}
                            </div>
